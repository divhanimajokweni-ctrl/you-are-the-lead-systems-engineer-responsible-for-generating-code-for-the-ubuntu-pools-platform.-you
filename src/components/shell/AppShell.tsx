    ...
    switch (icon) {
      ...
      case 'shield':
       ...
       case 'gamepad':
         return (
           <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2a2 2 0 00-2 2v5H5a2 2 0 00-2 2v5c0 1.1.9 2 2 2h10a2 2 0 002-2v-5h3a2 2 0 002-2V4a2 2 0 00-2-2z" />
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 10h1v4H9v-4zm4 0h1v4h-1v-4zm4 0h1v4h-1v-4z" />
           </svg>
         );
       default:
         return null;
